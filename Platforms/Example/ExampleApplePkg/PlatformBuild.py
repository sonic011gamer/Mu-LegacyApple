...
class CommonPlatform():
    ...
    '''
    PackagesSupported = ("ExampleApplePkg",)
    ArchSupported = ("ARM",)
    TargetsSupported = ("DEBUG", "RELEASE")
    Scopes = ('ExampleApple', 'gcc_arm_linux', 'edk2-build')
...
class SettingsManager(UpdateSettingsManager, SetupSettingsManager, PrEvalSettingsManager):
    ...
    def GetPlatformDscAndConfig(self) -> tuple:
        ...
        '''
        return ("ExampleApplePkg/ExampleApple.dsc", {})
...
class PlatformBuilder( UefiBuilder, BuildSettingsManager):
    ...
    def RetrieveCommandLineOptions(self, args):
        ...
        shell_environment.GetBuildVars().SetValue(
            "ACTIVE_PLATFORM", "ExampleApplePkg/ExampleApple.dsc", "From CmdLine")
    ...
    def SetPlatformEnv(self):
        ...
        self.env.SetValue("PRODUCT_NAME", "ExampleApple", "Platform Hardcoded")
        self.env.SetValue("ACTIVE_PLATFORM", "ExampleApplePkg/ExampleApple.dsc", "Platform Hardcoded")
